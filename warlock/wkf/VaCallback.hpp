...
class WKF_EXPORT VaCallbackLink
{
public:
...
class WKF_EXPORT VaCallbackGroupId
{
public:
   VaCallbackGroupId()
      : mId(0)
...
class WKF_EXPORT VaCallback : public VaUniqueId
{
public:
...
class WKF_EXPORT VaCallbackList : public VaObject
{
public:
   class WKF_EXPORT CallbackLink : public VaCallbackLink
   {
   public:
