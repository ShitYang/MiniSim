...
macro(configure_vis_plugin HOSTNAME PLUGIN_CONFIG_FILE)
   ...
   set(${HOSTNAME}_PLUGIN_BUILD TRUE) # Switch for whether a plugin is built by default
...
macro(plugin_cmakelists_template PLUGIN_NAME HOST_TARGET)
   ...
   add_library(${PLUGIN_NAME} SHARED ${SRCS} ${QRC} ${UI_HEADERS} ${PLUGIN_ADDITIONAL_SOURCES})
   ...
   if (PLUGIN_REQUIRES)
      ...
      #       target_link_libraries(${PLUGIN_NAME} PUBLIC ${req})
   ...
   if (PLUGIN_LIBRARIES)
      foreach(lib ${PLUGIN_LIBRARIES})
         target_link_libraries(${PLUGIN_NAME} PUBLIC ${lib})
      endforeach()
   endif()

   if (PLUGIN_QT_MODULES)
      foreach(module ${PLUGIN_QT_MODULES})
         target_link_libraries(${PLUGIN_NAME} PUBLIC Qt5::${module})
      endforeach()
   endif()
endmacro()
