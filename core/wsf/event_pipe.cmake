...
MACRO(add_event_pipe_schema SCHEMA_FILE SCHEMA_DEPENDS MESSAGE_BASE MESSAGE_BASE_FILE NAMESPACE BASE_NAME INCLUDES_VARIABLE SOURCES_VARIABLE)
   ...
   set(CLASS_HEADER "${CMAKE_BINARY_DIR}/include/${BASE_NAME}Classes.hpp")
   set(CLASS_SOURCE "${CMAKE_BINARY_DIR}/include/${BASE_NAME}Classes.cpp")
   set(REGISTER_HEADER "${CMAKE_BINARY_DIR}/include/${BASE_NAME}ClassesRegister.hpp")
   set(SCHEMA_HEADER "${CMAKE_BINARY_DIR}/include/${BASE_NAME}Schema.hpp")
